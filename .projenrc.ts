...
const project = new cdk.JsiiProject({
    ...
    description: "Homebrew component for projen projects",
    dependabot: false,
    depsUpgradeOptions: {
        workflowOptions: {
    ...
    name: "projen-homebrew",
    npmAccess: javascript.NpmAccess.PUBLIC,
    packageManager: javascript.NodePackageManager.PNPM,
    packageName: "@nikovirtala/projen-homebrew",
    peerDeps: ["projen", "constructs"],
    pnpmVersion: "10",
    projenrcTs: true,
    releaseToNpm: true,
    npmTrustedPublishing: true,
    repositoryUrl: "https://github.com/nikovirtala/projen-homebrew.git",
